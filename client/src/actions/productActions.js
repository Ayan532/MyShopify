...
export const newProduct = (productData) => async (dispatch) => {
    try {
        ...
        const { data } = await axios.post(`/api/v1/products/admin/product/new`, productData, config)
...
export const updateProduct = (id, productData) => async (dispatch) => {
    try {
        ...
        const { data } = await axios.put(`/api/v1/products/admin/product/${id}`, productData, config)
...
export const deleteReview = (id, productId) => async (dispatch) => {
    try {
        ...
        const { data } = await axios.delete(`/api/v1/products/reviews?id=${id}&productId=${productId}`)
